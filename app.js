...
(() => {
  ...
  function updateCosts(r,p){
    ...
    if(!c.valid){put('costPred','Check inputs');put('fuelPred','Use valid boiler and fuel values.');for(const id of ['costReported','costDifference','costCorrection','heatEquivalent','heatEquivalentDetail'])put(id,'—');return;}
